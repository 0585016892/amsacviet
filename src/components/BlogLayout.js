        ...
        <Row>
          ...
          <Col md={8} className="mb-4">
            <h2 className="mb-3">Bài viết mới nhất</h2>
              ...
              >
                ...
                >
                  V.YODY | Ngày đăng: {new Date(latestPost.created_at).toLocaleDateString()}
                </Card.Footer>
              </Card>
            )}
          </Col>
          ...
          <Col md={4} className="mb-4">
            ...
            {recommendedPosts.map((post) => (
              <Card
                key={post.id}
                className="d-flex flex-row align-items-start border-0 shadow-sm"
                ...
                >
                  ...
                  <Card.Body className="p-0">
                    <Card.Subtitle className="text-muted" style={{ fontSize: '0.75rem' }}>
                      V.YODY | Ngày đăng: {new Date(post.created_at).toLocaleDateString()}
                    </Card.Subtitle>
